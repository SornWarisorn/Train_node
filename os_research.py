...
sys.path.append('/home/vsa01/Desktop/tensorflow1/models/research:/home/vsa01/Desktop/tensorflow1/models/research/slim')
sys.path.extend(["/home/vsa01/Desktop/tensorflow1/models/research:/home/vsa01/Desktop/tensorflow1/models/research/slim"])
os.system('python3 setup.py build')
os.system('sudo python3 setup.py install')
os.system('python3 object_detection/builders/model_builder_test.py')

os.chdir('/home/vsa01/Desktop/tensorflow1/models/research/object_detection')
