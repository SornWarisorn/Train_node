def edit_faster(input_num='',input_path=''):
        number = input_num
        ...
        f = open('/home/vsa01/Desktop/tensorflow1/models/research/object_detection/training/faster_rcnn_inception_v2_pets.config', 'r')
        text = f.read()
        f.close()
    ...
    # ################## Check eval_input_reader ##########################################
        ...
        result = result_y
        print("Edit faster_rcnn_inception_v2_pets.config completed")
        w = open('/home/vsa01/Desktop/tensorflow1/models/research/object_detection/training/faster_rcnn_inception_v2_pets.config', 'w+')
        w.write(result)
        w.close()
