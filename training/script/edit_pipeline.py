def edit_pipeline(input_num='',input_path=''):
        ...
        f = open('/home/vsa01/Desktop/tensorflow1/models/research/object_detection/training/pipeline.config', 'r')
        text = f.read()
        f.close()
    ...
    # ################## Check eval_input_reader ##########################################
        ...
        w = open('/home/vsa01/Desktop/tensorflow1/models/research/object_detection/training/pipeline.config', 'w+')
        w.write(result)
        w.close()
